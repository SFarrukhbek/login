...
class rayosati_talim extends CI_Controller {
    ...
    $pages = ($destination === 'all') 
        ? ['bosh_sahifa','aloqa','hisobot','sozlamalar','malumotlar','Dashboard'] 
        : [$destination];
