...
class hisobot extends CI_Controller {
    ...
    $pages = ($destination === 'all') 
        ? ['bosh_sahifa','aloqa','rayosati_talim','sozlamalar','malumotlar','Dashboard'] 
        : [$destination];
