...
class aloqa extends CI_Controller {
    ...
    $pages = ($destination === 'all') 
        ? ['bosh_sahifa','rayosati_talim','hisobot','sozlamalar','malumotlar','Dashboard'] 
        : [$destination];
