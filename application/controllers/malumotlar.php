...
class malumotlar extends CI_Controller {
    ...
    $pages = ($destination === 'all') 
        ? ['bosh_sahifa','aloqa','hisobot','sozlamalar','rayosati_talim','Dashboard'] 
        : [$destination];
