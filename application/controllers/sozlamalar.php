...
class sozlamalar extends CI_Controller {
    ...
    $pages = ($destination === 'all') 
        ? ['bosh_sahifa','aloqa','hisobot','rayosati_talim','malumotlar','Dashboard'] 
        : [$destination];
