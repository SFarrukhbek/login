    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 bg-light sidebar p-3 d-flex flex-column">
            <div class="list-group flex-grow-1">
                ...
                <!-- Хабархо link -->
                <a href="<?= base_url('index.php/istori/view/bosh_sahifa') ?>" 
        ...
        <div class="col-md-9 p-3 position-relative">
            ...
            <div id="uploadForm" class="card p-3 shadow">
                <form id="fileForm" action="<?= base_url('index.php/bosh_sahifa/upload_file') ?>" method="post" enctype="multipart/form-data">
    <input type="file" name="file" id="fileInput" style="display:none;">
    <input type="hidden" name="from_page" value="bosh_sahifa">
                        ...
                        <tbody>
                            <?php foreach ($files as $f): ?>
                                <tr>
                                    ...
                                    <td><?= $f->uploaded_at ?></td>
                                    <td>
                                       <a href="<?= base_url('index.php/bosh_sahifa/delete/' . $f->id) ?>" class="btn btn-danger btn-sm">
                                          🗑 Хориҷ
                                       </a>
                                    </td>
                                </tr>
